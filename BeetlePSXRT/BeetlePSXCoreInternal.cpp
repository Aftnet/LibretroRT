...
unsigned int BeetlePSXCoreInternal::SerializationSize::get()
{
...
bool BeetlePSXCoreInternal::LoadGameInternal(IStorageFile^ gameFile)
{
...
void BeetlePSXCoreInternal::UnloadGameInternal()
{
	retro_unload_game();
}

void BeetlePSXCoreInternal::RunFrameInternal()
{
	retro_run();
}

void BeetlePSXCoreInternal::Reset()
{
	retro_reset();
}

bool BeetlePSXCoreInternal::Serialize(WriteOnlyArray<uint8>^ stateData)
{
	return retro_serialize(stateData->Data, stateData->Length);
}

bool BeetlePSXCoreInternal::Unserialize(const Array<uint8>^ stateData)
{
