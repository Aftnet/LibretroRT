    ...
    public class Locator
    {
        ...
        static Locator()
        {
            EmulationServiceLazy = new Lazy<EmulationService>(() =>
            {
                ...
                return new EmulationService(ioc.GetInstance<IUserDialogs>(), ioc.GetInstance<ILocalizationService>(), ioc.GetInstance<IPlatformService>(), ioc.GetInstance<ICryptographyService>(), ioc.GetInstance<InputManager>());
            });
        }
