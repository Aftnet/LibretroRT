...
BeetleSaturnCoreInternal::BeetleSaturnCoreInternal() : LibretroRT_Tools::CoreBase(retro_get_system_info, retro_get_system_av_info, retro_set_controller_port_device,
