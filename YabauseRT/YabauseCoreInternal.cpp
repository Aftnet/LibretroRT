...
YabauseCoreInternal^ coreInstance = nullptr;

YabauseCoreInternal^ YabauseCoreInternal::Instance::get()
{
	if (coreInstance == nullptr)
	{
		coreInstance = ref new YabauseCoreInternal();
...
YabauseCoreInternal::YabauseCoreInternal() : LibretroRT_Tools::CoreBase(retro_get_system_info, retro_get_system_av_info,
...
YabauseCoreInternal::~YabauseCoreInternal()
{
	coreInstance = nullptr;
}

void YabauseCoreInternal::OverrideDefaultOptions(IMapView<String^, CoreOption^>^ options)
{
