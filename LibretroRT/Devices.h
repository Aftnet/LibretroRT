...
namespace LibretroRT
{
	namespace Devices
	{
		...
		const unsigned int DeviceIdMouseHorizWheeldown = RETRO_DEVICE_ID_MOUSE_HORIZ_WHEELDOWN 8,
		...
		const unsigned int DeviceIdLightgunTrigger = RETRO_DEVICE_ID_LIGHTGUN_TRIGGER 2,
